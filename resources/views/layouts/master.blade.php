...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="{{ URL::to('assets/img/logo-hotel.png')}} ">
		...
		<div class="header">
			<div class="header-left">
				<a href="index.html" class="logo">
                    <img src="{{ URL::to('assets/img/logo-hotel.png')}}" width="50" height="70" alt="logo"> <span class="logoclass">HOTEL</span> 
                </a>
                <!-- when hamburger is closed only image is shown -->
				<a href="index.html" class="logo logo-small"> 
                    <img src="{{ URL::to('assets/img/logo-hotel.png')}} " alt="Logo" width="30" height="30"> 
                </a>
			</div>
			...
			<ul class="nav user-menu">
								...
								<li class="notification-message">
									<a href="#">
										<div class="media"> <span class="avatar avatar-sm">
											<img class="avatar-img rounded-circle" alt="User Image" src="{{ URL::to('assets/img/profiles/avatar-06.jpg')}}">
											</span>
									...
									<a href="#">
										<div class="media"> 
											...
											<div class="media-body">
                                                ...
                                                <span class="noti-title">due to maintainance</span></p>
				...
				<li class="nav-item dropdown has-arrow">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src=" assets/img/logo-hotel.png" width="31" alt="Hotel XYZ"></span> </a>
					<div class="dropdown-menu">
						<div class="user-header">
							<div class="avatar avatar-sm"> <img src="{{ URL::to('assets/img/logo-hotel.png')}} " alt="User Image" class="avatar-img rounded-circle"> </div>
							<div class="user-text">
								<h6>Hotel XYZ</h6>
